...
### Refactored
- Removed redundant DocBlocks across actions, repositories, and services to favor clean code and modern PHP features.

### Changed
- Improved explicit error handling in `SeedRepository` when retrieving authentication seeds.

## [2.1.5] - 2026-05-17

### Fixed
- Updated `ReceiveInvoiceAction` to use `sendInvoice` method for better consistency and orchestration.
