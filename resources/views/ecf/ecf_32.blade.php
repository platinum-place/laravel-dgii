    ...
    <Encabezado>
        ...
        <IdDoc>
            ...
            @if(!empty($IdDoc['TablaFormasPago']))
                <TablaFormasPago>
                    @foreach($IdDoc['TablaFormasPago'] as $formaPago)
                        <FormaDePago>
                            @isset($formaPago['FormaPago'])
                                <FormaPago>{{ $formaPago['FormaPago'] }}</FormaPago>
                            @endisset
                            @isset($formaPago['MontoPago'])
                                <MontoPago>{{ $formaPago['MontoPago'] }}</MontoPago>
                            @endisset
                        </FormaDePago>
                    @endforeach
                </TablaFormasPago>
        ...
        @endisset
        @isset($InformacionesAdicionales)
        ...
        <DetallesItems>
            @foreach($DetallesItems as $Item)
                <Item>
                    ...
                    @endisset
                    @isset($Item['TablaSubDescuento'])
                        <TablaSubDescuento>
                            @foreach($Item['TablaSubDescuento'] as $SubDescuento)
                                <SubDescuento>
                                    @isset($SubDescuento['TipoSubDescuento'])
                    ...
                    @endisset
                    @isset($Item['TablaSubRecargo'])
                        <TablaSubRecargo>
                            @foreach($Item['TablaSubRecargo'] as $SubRecargo)
                                <SubRecargo>
                                    @isset($SubRecargo['TipoSubRecargo'])
