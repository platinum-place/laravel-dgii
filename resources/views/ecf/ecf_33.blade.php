...
<ECF>
    ...
    <DetallesItems>
        @foreach($DetallesItems as $Item)
            <Item>
                ...
                @endisset
                @if(!empty($Item['TablaSubcantidad']))
                    <TablaSubcantidad>
                        ...
                        <SubtotalImpuestoAdicional>
                            @isset($Pagina['SubtotalImpuestoAdicional']['SubtotalImpuestoSelectivoConsumoEspecificoPagina'])
                                <SubtotalImpuestoSelectivoConsumoEspecificoPagina>
                                    {{ $Pagina['SubtotalImpuestoAdicional']['SubtotalImpuestoSelectivoConsumoEspecificoPagina'] }}
                                </SubtotalImpuestoSelectivoConsumoEspecificoPagina>
                            @endisset
    ...
    <InformacionReferencia>
        ...
        @endisset
        @isset($InformacionReferencia['RazonModificacion'])
            <RazonModificacion>{{ $InformacionReferencia['RazonModificacion'] }}</RazonModificacion>
        @endisset
    </InformacionReferencia>
